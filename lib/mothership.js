(function () {
  ...
  MotherShip.prototype.draw = function (ctx) {
    var thetaX = this.pos[0] - this.game.fleetShips[0].pos[0];
    var thetaY = this.pos[1] - this.game.fleetShips[0].pos[1];
  ...
  MotherShip.prototype.move = function (delta) {
    ...
    var dist = Asteroids.Util.dist(this.pos, this.game.fleetShips[0].pos);
    if (dist > 500) {
