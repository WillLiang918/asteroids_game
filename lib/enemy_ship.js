(function () {
  ...
  var EnemyShip = Asteroids.EnemyShip = function (options) {
    // options.radius = options.radius || EnemyShip.RADIUS;
    options.health = options.health || 100;
    options.explosionSize = options.explosionSize || 60;
    // this.distance = options.distance || 300;
    // this.speed = options.speed || 0.1;
    this.targetShip = options.game.ships[0];
