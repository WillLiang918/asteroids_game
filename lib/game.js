(function () {
  ...
  Game.prototype.allObjects = function () {
    return [].concat(this.ships, this.asteroids, this.bullets, this.enemyShips);
  };
  ...
  Game.prototype.draw = function (ctx) {
    ...
    ctx.fillText("Rank", Game.DIM_X - 200, 50);
    ctx.fillText(this.rank, Game.DIM_X - 125, 50);

    ctx.fillText("Weapon", Game.DIM_X - 200, 75);
    ctx.fillText(this.weapon, Game.DIM_X - 125, 75);

    ctx.fillText("Speed", Game.DIM_X - 200, 100);
    ctx.fillText(this.speed, Game.DIM_X - 125, 100);

    ctx.fillText("Agility", Game.DIM_X - 200, 125);
    ctx.fillText(this.agility, Game.DIM_X - 125, 125);
