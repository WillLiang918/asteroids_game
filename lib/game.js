(function () {
  ...
  Game.prototype.draw = function (ctx) {
    ...
    ctx.fillText("Shields", Game.DIM_X / 2 - 75, 50);
    ctx.fillText(Math.floor(this.shields) + "%", Game.DIM_X / 2, 50);

    ctx.fillText("Weapon", 30, 75);
    ctx.fillText(this.weapon, 105, 75);

    ctx.fillText("Speed", 30, 100);
    ctx.fillText(this.speed, 105, 100);

    ctx.fillText("Agility", 30, 125);
    ctx.fillText(this.agility, 105, 125);
